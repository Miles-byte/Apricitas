...
CHINA_IMPORT_PRICES_GRAPH <- ggplot() + #plotting integrated circuits exports
  ...
  labs(caption = "Graph created by @JosephPolitano using BLS data",subtitle = "Chinese Import Prices Have Barely Fallen—Implying Americans are Primarily Absorbing the Costs") +
  ...
  annotation_custom(apricitas_logo_rast, xmin = as.Date("2022-01-01")-(.1861*(today()-as.Date("2022-01-01"))), xmax = as.Date("2022-01-01")-(0.049*(today()-as.Date("2022-01-01"))), ymin = 97.5-(.3*25), ymax = 97.5) +
