...
JUNE_HS4_IMPORTS_NO_TARIFF <- JUNE_HS4_IMPORTS_NO_TARIFF %>%
  ...
  mutate(Category = factor(Category, levels = rev(c("Computers & Parts","Mexico (USMCA-compliant)","Canada (USMCA-compliant)","Pharmaceuticals","Smartphones","Energy","Precious Metals","Critical Minerals","Copper & Related","Lumber & Related","Semiconductor Equipment"))))
