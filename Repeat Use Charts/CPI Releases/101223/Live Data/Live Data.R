...
CPIPCT_Graph <- ggplot() + #plotting CPI/PCEPI against 2% CPI trend
  ...
  theme_apricitas + theme(legend.position = c(.30,.50)) +
...
Manheim_Bulk <- read.xlsx("https://site.manheim.com/wp-content/uploads/sites/2/2023/10/Sep-2023-ManheimUsedVehicleValueIndex-web-table-data-.xlsx") %>%
