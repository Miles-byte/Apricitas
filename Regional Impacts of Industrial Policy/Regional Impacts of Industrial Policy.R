...
REAL_US_CONSTRUCTION_GROWTH_Graph <- ggplot() + #indexed investment growth
  ...
  annotate("text", label = "Inflation\nReduction\n& CHIPS Acts", x = as.Date("2022-09-16"), y = 1.6, color = "white", size = 4, hjust = 0, lineheight = 0.8, alpha = 0.75) +
  annotate("vline", x = as.Date("2021-11-15"), xintercept = as.Date("2021-11-15"), color = "white", size = 1, linetype = "dashed", alpha = 0.75) +
  annotate("text", label = "Bipartisan\nInfrastructure\nLaw", x = as.Date("2021-10-15"), y = 1.6, color = "white", size = 4, hjust = 1, lineheight = 0.8, alpha = 0.75) +
  ...
  xlab("Date") +
  scale_y_continuous(labels = scales::percent_format(), limits = c(-.25,2.00), expand = c(0,0)) +
  ...
  annotation_custom(apricitas_logo_rast, xmin = as.Date("2018-01-01")-(.1861*(today()-as.Date("2018-01-01"))), xmax = as.Date("2018-01-01")-(0.049*(today()-as.Date("2018-01-01"))), ymin = -.25-(.3*2.25), ymax = -.25) + #these repeated sections place the logo in the bottom-right of each graph. The first number in all equations is the chart's origin point, and the second number is the exact length of the x or y axis
