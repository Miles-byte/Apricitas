pacman::p_load(openxlsx,sf,tidycensus,cli,remotes,magick,cowplot,knitr,ghostscript,png,httr,grid,usethis,pacman,rio,ggplot2,ggthemes,quantmod,dplyr,data.table,lubridate,forecast,gifski,av,tidyr,gganimate,zoo,RCurl,Cairo,datetime,stringr,pollster,tidyquant,hrbrthemes,plotly,fredr)
...
COUNTY_FREE_CLEAR_REG_graph <- ggplot() + #plotting traditional Unemployment/PCE Inflation curve
  ...
  labs(caption = "Graph created by @JosephPolitano using Redfin and Census data", subtitle = "The Relationship Between Inventory Growth and Free-and Clear Ownership is Still Weak") +
