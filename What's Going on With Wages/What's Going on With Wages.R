...
ECIPRIVCOMP <- fredr(series_id = "CIU2010000000000I",observation_start = as.Date("2018-01-01")) #downloading "Employment Cost Index - Total Compensation for Private Industry workers" data from Fred to calculate Gross Labor Income using a second method
...
GLI_CPS_NCS <- merge(ECIPRIVCOMP,ELEV, by = "date") #merging ECI and EPOP data for the second GLI calculation method
